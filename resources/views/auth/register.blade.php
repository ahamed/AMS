                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="/register">
                        ...
                        <div class="form-group{{ $errors->has('institute') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">Institute</label>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="building_id" class="col-md-4 control-label">Building ID</label>

                            <div class="col-md-6">
                                <input id="building_id" type="text" class="form-control" name="building_id" value="{{ old('building_id') }}" required autofocus>
